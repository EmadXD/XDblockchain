...
*/
package proxy.blockchain.emadxd.blockchain_sources;
...
public final class TorConfig {
    ...
    public final static String TORRC_NAME = "blockchain_config";
    ...
    /**
     * Resolves the tor configuration file. If the blockchain_config file hasn't been set, then this method will attempt to
     * resolve the config file by looking in the root of the $configDir and then in $user.home directory
     *
     * @return blockchain_config file
     * @throws IOException if blockchain_config file is not resolved
     */
                ...
                if (!tmpTorrcFile.exists()) {
                    ...
                    if (!tmpTorrcFile.exists()) {
                        ...
                        if (!torrcFile.createNewFile()) {
                            throw new IOException("Failed to create blockchain_config file");
                        }
                    } else {
    ...
    public void setTorExecutableFile(File torExecutableFile) {
        this.torExecutableFile = torExecutableFile;
    }
    ...
    public static class Builder {
         ...
         * <p>
         * Default value: $configDir/blockchain_config
         *
         * @param file
         * @return
         */
        ...
        private static String getTorExecutableFileName() {
            switch (OsData.getOsType()) {
                case ANDROID:
                    return "lib_emadxd_blockchain.so";
                case LINUX_32:
                case LINUX_64:
                case MAC:
                    return "tor";
